...
import { ButtonsCard } from "./ui/button/ButtonsCard";
...
export function TailwindcssButtons() {
  ...
  return (
    <div className="w-full px-4 pb-40">
      ...
      <div className="grid w-full grid-cols-1 gap-10 mx-auto md:grid-cols-2 lg:grid-cols-3 max-w-7xl">
...
export const buttons = [
  ...
  },
  {
    ...
    component: (
      <button className="px-4 py-2 text-sm transition duration-200 transform border rounded-md border-neutral-300 bg-neutral-100 text-neutral-500 hover:-translate-y-1 hover:shadow-md">
        Simple
      </button>
    ),
  },
  {
    ...
    component: (
      <button className="px-8 py-2 font-bold text-white transition duration-200 bg-teal-500 border-2 border-transparent rounded-md hover:bg-white hover:text-black hover:border-teal-500">
        Invert it
      </button>
    ),
  },
  {
    ...
    showDot: false,
    component: (
      <button className="relative inline-block p-px text-xs font-semibold leading-6 text-white no-underline rounded-full shadow-2xl cursor-pointer bg-slate-800 group shadow-zinc-900">
  ...
  },
  {
    ...
    component: (
      <button className="px-8 py-2 text-white transition duration-200 rounded-full bg-gradient-to-b from-blue-500 to-blue-600 focus:ring-2 focus:ring-blue-400 hover:shadow-xl">
        Gradient
      </button>
    ),
  },
  {
    ...
    component: (
      <button className="relative px-8 py-2 text-black transition duration-200 bg-transparent border border-black dark:border-white group">
  ...
  },
  {
    ...
    component: (
      <button className="px-4 py-2 text-black transition duration-200 bg-white border rounded-xl border-neutral-600 hover:bg-gray-100">
        Outline
      </button>
    ),
  },
  ...
  },
  {
    ...
    component: (
      <button className="px-6 py-2 font-bold text-white transition transform bg-black rounded-lg hover:-translate-y-1 duration-400">
        Figma
      </button>
    ),
  },
  ...
  },
  {
    ...
    component: (
      <button className="px-8 py-2 rounded-full relative bg-slate-700 text-white text-sm hover:shadow-2xl hover:shadow-white/[0.1] transition duration-200 border border-slate-600">
        <div className="absolute inset-x-0 w-1/2 h-px mx-auto shadow-2xl -top-px bg-gradient-to-r from-transparent via-teal-500 to-transparent" />
