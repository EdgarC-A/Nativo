      ...
      <div className="flex-none group/card md:mt-10">
        <div
          className={cn(
            ...
            "bg-[url(https://img.freepik.com/foto-gratis/sombrero-colgado-pomo-puerta_23-2149456963.jpg?t=st=1727481462~exp=1727485062~hmac=e385af717dc361785c9f64e3d83a12894f846489f798ac67798a86046de9dae8&w=740)] bg-cover"
          )}
        >
          ...
          /> */}
            <div className="flex flex-col ">
              ...
              <p className="text-sm text-gray-400">Bolivar</p>
            </div>
          </div>
