...
import {
  ...
  ModalFooter,
  ModalTrigger,
} from "./ui/Modal-desing/animated-modal";
...
const PlaneIcon = ({}: { className?: string }) => {
  return (
    <img
      width="24"
      height="24"
      src="https://img.icons8.com/plumpy/24/pepper-grinder.png"
      alt="pepper-grinder"
    />
  );
};
...
const ElevatorIcon = ({ className }: { className?: string }) => {
  return (
    <img
      width="24"
      height="24"
      src="https://img.icons8.com/external-wanicon-flat-wanicon/64/external-onion-fruits-and-vegetables-wanicon-flat-wanicon.png"
      alt="external-onion-fruits-and-vegetables-wanicon-flat-wanicon"
    />
  );
};
